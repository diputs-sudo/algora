...
const grid = document.getElementById("algorithmGrid") as HTMLElement | null;
const searchInput = document.getElementById("searchInput") as HTMLInputElement | null;
const filterButtons = Array.from(
    document.querySelectorAll(".sorting-filter-chip")
) as HTMLButtonElement[];
const viewButtons = Array.from(
    document.querySelectorAll(".searching-view-btn")
) as HTMLButtonElement[];
const viewTitle = document.getElementById("searchingViewTitle") as HTMLElement | null;
const viewSummary = document.getElementById("searchingViewSummary") as HTMLElement | null;

let activeFilter = "all";
let activeView = "core";

const viewCopy: Record<string, { title: string; summary: string }> = {
    core: {
        title: "Searching",
