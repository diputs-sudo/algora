...
export class SearchVisualizer {
    ...
    private uniformBinaryRoot: HTMLDivElement;
    private fibonacciRoot: HTMLDivElement;
    ...
    private renderUniformBinaryInsight(insight?: UniformBinaryInsight) {
        if (!insight) {
    ...
    private renderFibonacciInsight(insight?: FibonacciSearchInsight) {
        if (!insight) {
    ...
    private renderRangeSearchInsight(insight?: RangeSearchInsight) {
        if (!insight) {
    ...
    private renderJumpSearchInsight(insight?: JumpSearchInsight) {
        if (!insight) {
    ...
    private renderSentinelLinearInsight(insight?: SentinelLinearInsight) {
        if (!insight) {
    ...
    private renderFractionalCascadingInsight(insight?: FractionalCascadingInsight) {
        if (!insight) {
    ...
    private renderHashTableInsight(insight?: HashTableInsight) {
        if (!insight) {
...
function createUniformMetric(label: string, primary: string, secondary: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createFibonacciMetric(label: string, primary: string, secondary: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createRangeMetric(label: string, primary: string, secondary: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createJumpMetric(label: string, primary: string, secondary: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createSentinelMetric(label: string, primary: string, secondary: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createBitonicMetric(label: string, primary: string, secondary: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createHashFormulaCell(label: string, value: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createHashFormulaArrow(text: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createHashPathNode(label: string, value: string, active: boolean): HTMLDivElement {
    const root = document.createElement("div");
...
function createHashPathLine(text: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createHashTableMetric(label: string, primary: string, secondary: string): HTMLDivElement {
    const root = document.createElement("div");
...
function createInlineStrong(text: string): HTMLElement {
    const element = document.createElement("strong");
    element.textContent = text;
    return element;
}

function createInlineEm(text: string): HTMLElement {
...
function formatSearchIndex(index: number): string {
    if (index < 0) {
        return "before start";
    }
...
function formatUniformIndex(index: number): string {
    if (index < 0) {
        return "before start";
    }
...
function formatFibonacciDirection(direction: FibonacciSearchInsight["direction"]): string {
    switch (direction) {
        case "left":
            return "Keep left";
        case "right":
...
function formatRangeInterval(insight: RangeSearchInsight): string {
...
function formatRangePhase(phase: RangeSearchInsight["phase"]): string {
    switch (phase) {
        case "binary":
...
function formatJumpPhase(phase: JumpSearchInsight["phase"]): string {
    switch (phase) {
        case "scan":
            return "Linear scan";
        case "found":
...
function formatSentinelPhase(phase: SentinelLinearInsight["phase"]): string {
    switch (phase) {
        case "scan":
            return "Scanning";
        case "verify":
...
function formatBitonicPhase(phase: BitonicSearchInsight["phase"]): string {
    switch (phase) {
        case "left":
            return "Search left";
        case "right":
...
function formatFractionalRowState(insight: FractionalCascadingInsight, catalogIndex: number): string {
    if (catalogIndex < insight.catalogIndex) {
        return "linked";
    }
...
function formatHashTablePhase(phase: HashTableInsight["phase"]): string {
    switch (phase) {
        case "collision":
            return "Collision";
        case "lookup":
...
function formatHashComparisonDetail(insight: HashTableInsight): string {
    if (insight.phase === "miss") {
...
function formatHashPathResult(phase: HashTableInsight["phase"]): string {
    switch (phase) {
        case "collision":
            return "blocked";
        case "lookup":
...
function formatProbeCount(count: number): string {
    return count === 1 ? "probe for this key" : "probes for this key";
}

function formatUniformDirection(direction: UniformBinaryInsight["direction"]): string {
    switch (direction) {
        case "left":
            return "Move left";
        case "right":
