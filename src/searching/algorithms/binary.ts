...
export function createBinarySearchInitialStep(array: number[], target: number): SearchStep {
    ...
    while (low <= high) {
        ...
        yield {
            ...
            workspace: createWorkspace(
                ...
                mid,
                high,
                `Compare target ${target} with middle value ${value} at index ${mid}.`
            )
        };
        ...
        if (value < target) {
            ...
            yield {
                ...
                workspace: createWorkspace(
                    ...
                    mid,
                    high,
                    `${value} is smaller than ${target}, so the search continues to the right.`
                )
            };
        } else {
            high = mid - 1;
            ...
            yield {
                ...
                workspace: createWorkspace(
                    ...
                    mid,
                    high,
                    `${value} is larger than ${target}, so the search continues to the left.`
                )
            };
        }
    }
