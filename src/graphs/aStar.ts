...
function createRandomGrid(): GraphData {
    const start: GridPoint = { row: 6, col: 0 };
    const target: GridPoint = { row: 0, col: 9 };
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const normalModeBtn = document.getElementById("normalModeBtn") as HTMLButtonElement;
    const weightedModeBtn = document.getElementById("weightedModeBtn") as HTMLButtonElement;
    const heuristicWeightInput = document.getElementById("heuristicWeight") as HTMLInputElement;
    ...
    function setMode(weighted: boolean) {
