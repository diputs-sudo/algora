import { GraphData, GridPoint } from "./types.js";

export interface ClusterGridOptions {
    clusterCount?: number;
    minGrowth?: number;
    maxGrowth?: number;
    attempts?: number;
...
export function createClusterGrid(
    ...
    for (let attempt = 0; attempt < attempts; attempt++) {
        ...
        if (walls.size > bestWalls.size) bestWalls = walls;
    }
