...
export class GraphVisualizer {
    ...
    private visitCounter: HTMLDivElement;
    private statusRoot: HTMLDivElement;
    private gridShell: HTMLDivElement;
    private columnLabels: HTMLDivElement;
    private rowLabels: HTMLDivElement;
    ...
    private renderWorkspace(workspace?: GraphWorkspaceState) {
