import { breadthFirstSearch, createBfsInitialStep } from "./algorithms/bfs.js";
...
document.addEventListener("DOMContentLoaded", () => {
    initLearnMore();
    initCodeLoader("graphs", "bfs", {
        rootSelector: "#standardCodeSection",
        defaultLanguage: "python",
        moreInfoSelector: "#standardMoreInfo"
    });
    initCodeLoader("graphs", "bfs_production", {
        rootSelector: "#productionCodeSection",
        defaultLanguage: "python"
    });
    const visualizer = new GraphVisualizer("bfsContainer");
    ...
    const controller = new GraphController(breadthFirstSearch(graph), visualizer);
    controller.reset(breadthFirstSearch(graph), createBfsInitialStep(graph));
