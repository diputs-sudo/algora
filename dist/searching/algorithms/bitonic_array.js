function createPeakWorkspace(array, target, left, mid, right, detail) {
    return {
...
function createBinaryWorkspace(array, target, low, mid, high, peak, direction, detail) {
    return {
...
export function* bitonicArraySearch(array, target) {
...
function* directionalBinarySearch(array, target, lowStart, highStart, peak, direction, probes) {
    let low = lowStart;
    let high = highStart;
