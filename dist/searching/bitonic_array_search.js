...
function normalizeBitonicArray(values) {
...
function generateBitonicArray(size) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function reset() {
        ...
        datasetInput.value = dataset.join(",");
        controller.reset(bitonicArraySearch(dataset, target), createBitonicArraySearchInitialStep(dataset, target));
